// ======================================================================
// ESP8266_Interface.v generated from TopDesign.cysch
// 03/14/2017 at 15:14
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=115200, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=0, Enable_RXIntInterrupt=1, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=true, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=0, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=true, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=false, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=921600, RXAddressMode=0, RXBufferSize=32, RxBuffRegSizeReplacementString=uint8, RXEnable=false, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=UART_v2_50, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LOG, CY_INSTANCE_SHORT_NAME=LOG, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=LOG, )
module UART_v2_50_1 (
    cts_n,
    tx,
    rts_n,
	...
	cy_clock_v1_0
		#(.id("7367d945-190f-43dc-ad83-fed55032bfb2/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1085069444.44444"),
		  .is_direct(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("b8dfd70e-8432-4de2-8159-249880535a61"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    UART_v2_50_0 WIFIdev_Channel (
        ...
        .rx_data(Net_17),
        .rx_clk(Net_18));
    defparam WIFIdev_Channel.Address1 = 0;
    defparam WIFIdev_Channel.Address2 = 0;
    defparam WIFIdev_Channel.EnIntRXInterrupt = 1;
    defparam WIFIdev_Channel.EnIntTXInterrupt = 0;
    defparam WIFIdev_Channel.FlowControl = 0;
    defparam WIFIdev_Channel.HalfDuplexEn = 0;
    defparam WIFIdev_Channel.HwTXEnSignal = 1;
    defparam WIFIdev_Channel.NumDataBits = 8;
    defparam WIFIdev_Channel.NumStopBits = 1;
    defparam WIFIdev_Channel.ParityType = 0;
    defparam WIFIdev_Channel.RXEnable = 1;
    defparam WIFIdev_Channel.TXEnable = 1;
    ...
    UART_v2_50_1 LOG (
        ...
        .rx_data(Net_30),
        .rx_clk(Net_31));
    defparam LOG.Address1 = 0;
    defparam LOG.Address2 = 0;
    defparam LOG.EnIntRXInterrupt = 1;
    defparam LOG.EnIntTXInterrupt = 0;
    defparam LOG.FlowControl = 0;
    defparam LOG.HalfDuplexEn = 0;
    defparam LOG.HwTXEnSignal = 1;
    defparam LOG.NumDataBits = 8;
    defparam LOG.NumStopBits = 1;
    defparam LOG.ParityType = 0;
    defparam LOG.RXEnable = 0;
    defparam LOG.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("152f629a-eade-463f-9b44-7f515aa50c8e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2bda527b-3f37-4985-8a53-8a58f0003ff2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
